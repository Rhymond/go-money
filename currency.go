...
var (
	...
	currencies = map[string]*Currency{
		...
		BYR: {Decimal: ",", Thousand: " ", Code: BYR, Fraction: 0, NumericCode: "974", Grapheme: "p.", Template: "1 $"},
		...
		EEK: {Decimal: ".", Thousand: ",", Code: EEK, Fraction: 2, NumericCode: "233", Grapheme: "kr", Template: "$1"},
		...
		GHC: {Decimal: ".", Thousand: ",", Code: GHC, Fraction: 2, NumericCode: "288", Grapheme: "\u00a2", Template: "$1"},
		...
		LTL: {Decimal: ".", Thousand: ",", Code: LTL, Fraction: 2, NumericCode: "440", Grapheme: "Lt", Template: "$1"},
		LVL: {Decimal: ".", Thousand: ",", Code: LVL, Fraction: 2, NumericCode: "428", Grapheme: "Ls", Template: "1 $"},
		...
		RUR: {Decimal: ".", Thousand: ",", Code: RUR, Fraction: 2, NumericCode: "810", Grapheme: "\u20bd", Template: "1 $"},
		...
		SKK: {Decimal: ".", Thousand: ",", Code: SKK, Fraction: 2, NumericCode: "703", Grapheme: "Sk", Template: "$1"},
		...
		STD: {Decimal: ".", Thousand: ",", Code: STD, Fraction: 2, NumericCode: "678", Grapheme: "Db", Template: "1 $"},
		...
		TRL: {Decimal: ".", Thousand: ",", Code: TRL, Fraction: 2, NumericCode: "792", Grapheme: "\u20a4", Template: "$1"},
		...
		XOF: {Decimal: ".", Thousand: ",", Code: XDR, Fraction: 0, NumericCode: "952", Grapheme: "0", Template: "1 $"},
		...
		BOV: {Decimal: ".", Thousand: ",", Code: BOV, Fraction: 2, NumericCode: "984", Grapheme: "0", Template: "$1"},
		COU: {Decimal: ".", Thousand: ",", Code: COU, Fraction: 2, NumericCode: "970", Grapheme: "0", Template: "$1"},
		MGA: {Decimal: ".", Thousand: ",", Code: MGA, Fraction: 2, NumericCode: "969", Grapheme: "0", Template: "$1"},
		MRU: {Decimal: ".", Thousand: ",", Code: MRU, Fraction: 2, NumericCode: "929", Grapheme: "0", Template: "$1"},
		XUA: {Decimal: ".", Thousand: ",", Code: XUA, Fraction: 0, NumericCode: "965", Grapheme: "0", Template: "$1"},
		MXV: {Decimal: ".", Thousand: ",", Code: MXV, Fraction: 2, NumericCode: "979", Grapheme: "0", Template: "$1"},
		STN: {Decimal: ".", Thousand: ",", Code: STN, Fraction: 2, NumericCode: "930", Grapheme: "0", Template: "$1"},
		XSU: {Decimal: ".", Thousand: ",", Code: XSU, Fraction: 0, NumericCode: "994", Grapheme: "0", Template: "$1"},
		CHE: {Decimal: ".", Thousand: ",", Code: CHE, Fraction: 2, NumericCode: "947", Grapheme: "0", Template: "$1"},
		CHW: {Decimal: ".", Thousand: ",", Code: CHW, Fraction: 2, NumericCode: "948", Grapheme: "0", Template: "$1"},
		USN: {Decimal: ".", Thousand: ",", Code: USN, Fraction: 2, NumericCode: "997", Grapheme: "0", Template: "$1"},
		...
		XBA: {Decimal: ".", Thousand: ",", Code: XBA, Fraction: 0, NumericCode: "955", Grapheme: "0", Template: "$1"},
		XBB: {Decimal: ".", Thousand: ",", Code: XBB, Fraction: 0, NumericCode: "956", Grapheme: "0", Template: "$1"},
		XBC: {Decimal: ".", Thousand: ",", Code: XBC, Fraction: 0, NumericCode: "957", Grapheme: "0", Template: "$1"},
		XBD: {Decimal: ".", Thousand: ",", Code: XBD, Fraction: 0, NumericCode: "958", Grapheme: "0", Template: "$1"},
		XTS: {Decimal: ".", Thousand: ",", Code: XTS, Fraction: 0, NumericCode: "963", Grapheme: "0", Template: "$1"},
		XXX: {Decimal: ".", Thousand: ",", Code: XXX, Fraction: 0, NumericCode: "999", Grapheme: "0", Template: "$1"},
		XPD: {Decimal: ".", Thousand: ",", Code: XPD, Fraction: 0, NumericCode: "964", Grapheme: "0", Template: "$1"},
		XPT: {Decimal: ".", Thousand: ",", Code: XPT, Fraction: 2, NumericCode: "962", Grapheme: "0", Template: "$1"},
	}
...
func loadNumericCodeCurrenciesMap() (currenciesByCode map[string]*Currency) {
	...
	for _, currency := range currencies {
		if currency.NumericCode != "" {
			currenciesByCode[currency.NumericCode] = currency
		}
	}
	return
}
